            ...
            return (
                <View>
                    <DropDown
                        label="Teacher Name"
                        mode={"outlined"}
                        visible={showTeacherDrop}
                        value={teacherEmail}
                        setValue={setTeacherEmail}
                        list={teachersList}
                        showDropDown={() => setShowTeacherDrop(true)}
                        onDismiss={() => setShowTeacherDrop(false)}
                    />
                    <Button mode="contained-tonal" name="get_attendance" key="get_attendance" onPress={onPress}>
